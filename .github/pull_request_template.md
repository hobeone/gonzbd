...
- [ ] **Every intentional snapshot-then-release lock pattern has a `// --- No lock held below this line ---` comment** (`docs/go-standards.md` § Concurrency & Locking) if this PR unlocks a mutex mid-function rather than via `defer`.
