...
<Modal bind:open ariaLabel="Settings" class="flex h-[85vh] w-full max-w-4xl overflow-hidden rounded-3xl">
	<!-- Sidebar -->
	<aside class="w-64 shrink-0 border-r border-border/80 dark:border-slate-800 bg-slate-50 dark:bg-[#0B101B] p-5">
