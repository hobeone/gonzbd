...
<section class="space-y-6">
	...
	<div>
		...
		<div class="divide-y divide-gray-100 dark:divide-gray-800">
			...
			<ConfigSwitch section="postproc" keyword="direct_unpack" label="Direct Unpack" value={configData.postproc.direct_unpack} description="Extract RAR volumes while still downloading, overlapping I/O for faster completion. Requires 'Enable unrar' and is incompatible with 'Prefer 7zip' (7z doesn't support unrar's interactive volume protocol)." onupdate={onFieldUpdate} />
