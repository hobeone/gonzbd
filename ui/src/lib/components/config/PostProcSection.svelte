...
<section class="space-y-6">
	...
	<div>
		...
		<div class="divide-y divide-gray-100 dark:divide-gray-800">
			...
			<ConfigSwitch section="postproc" keyword="prefer_7zip" label="Prefer 7-Zip for RAR" value={configData.postproc.prefer_7zip} description="Use 7z instead of the built-in extractor for RAR archives. Overrides 'Use built-in RAR extractor'." onupdate={onFieldUpdate} />
