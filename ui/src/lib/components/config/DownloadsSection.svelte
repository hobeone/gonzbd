...
<section class="space-y-6">
	...
	<div class="divide-y divide-gray-100 dark:divide-gray-800">
		...
		<ConfigInput section="downloads" keyword="write_cache_size" label="Article Cache" value={configData.downloads.write_cache_size} description="In-memory cache size (e.g. 500M)." onupdate={onFieldUpdate} />
