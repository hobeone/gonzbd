...
<section class="space-y-6">
	...
	<div class="divide-y divide-gray-100 dark:divide-gray-800">
		<ConfigInput section="general" keyword="host" label="Host" value={configData.general.host} description="Host or IP to bind the HTTP server to. 0.0.0.0 means all interfaces." requiresRestart={true} onupdate={onFieldUpdate} />
